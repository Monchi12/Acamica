...
Listado.prototype.buscarRestaurante = function(id) {
    var restaurante = this.restaurantes.find( restaurant => restaurant.id == id)
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    var ubicaciones =  this.restaurantes.map(function(restaurante){
        return restaurante.ubicacion;
    });
    return this.eliminarRepetidos(ubicaciones);
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    return this.eliminarRepetidos(horarios);
}
