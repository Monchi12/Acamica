...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 150, 460, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 460, 30, 30, 1),


    new Obstaculo('imagenes/valla_vertical.png', 400, 380, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 480, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 400, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 600, 120, 30, 30, 1),

    new Obstaculo('imagenes/bache.png', 100, 300, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 300, 440, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 860, 500, 30, 30, 2),

    new Obstaculo('imagenes/auto_verde_abajo.png', 800, 80, 15, 30, 3),
    new Obstaculo('imagenes/auto_verde_abajo.png', 530, 200, 15, 30, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 280, 250, 30, 15, 3),
  ...
  enemigos: [
    ...
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 1, rangoMov, 'h'),

    new ZombieCaminante('imagenes/zombie1.png', 200, 450, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie2.png', 300, 500, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie3.png', 470, 300, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie4.png', 770, 400, 10, 10, 1, rangoMov)
  ]
